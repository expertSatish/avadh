    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class=" container card-fixed-align">
            ...
            <div class="card card-custom">
                <!--begin::Form-->
                <form action="{{route('director-message.update',$data->id)}}" method="post"
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-4 form-group">
                                <label>Image </label>
                                <input class="form-control" name="hod_image" type="file" />
                                @if($errors->has('hod_image'))
                                <div class="invalid-feedback">{{ $errors->first('hod_image') }}</div>
                                @enderror
                            </div>
                        </div>
                        <div class="row">
