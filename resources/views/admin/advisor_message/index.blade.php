        ...
        <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                ...
                <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">
                    Advisoror Message</h5>
                <div class="subheader-separator subheader-separator-ver mt-2 mb-2 mr-4 bg-gray-200"></div>
                @if(!$availData)
                <a href="{{route('advisor-message.create')}}" class="btn btn-light-warning font-weight-bolder btn-sm">
                    Add New
                </a>
                @endif
                <!--end::Page Title-->
    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class=" container card-fixed-align">
            ...
            <div class="card card-custom">
                ...
                <div class="card-body">
                    <!--begin: Datatable-->
                    <table class="table table-bordered advisor_message-dataTable">
                        <thead>
                            <tr>
                                <th>Name</th>
                                <th>Image</th>
