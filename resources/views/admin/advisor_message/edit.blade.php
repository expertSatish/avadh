    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class=" container card-fixed-align">
            ...
            <div class="card card-custom">
                <!--begin::Form-->
                <form action="{{route('advisor-message.update',$data->id)}}" method="post"
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-4 form-group">
                                <label>Name </label>
                                <input class="form-control" name="name" value="@if(old('name')){{ old('name') }}@elseif($data){{$data->name}}@endif" type="text" />
                                @if($errors->has('name'))
                            ...
                            <div class="col-md-4 form-group">
                                <label>Image </label>
                                <input class="form-control" name="advisor_image" type="file" />
                                @if($errors->has('advisor_image'))
                                <div class="invalid-feedback">{{ $errors->first('advisor_image') }}</div>
                                @enderror
                            </div>
                        </div>
                        <div class="row">
