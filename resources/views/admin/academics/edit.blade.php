    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class=" container card-fixed-align">
            ...
            <div class="card card-custom">
                <!--begin::Form-->
                <form action="{{route('manage-academics.update',$data->id)}}" method="post">
                @method('PATCH')
                    @csrf
                    <div class="card-body">
                        <div class="row">
                        ...
                        <div class="col-md-4 form-group">
                                ...
                                <input class="form-control" name="academic_name" placeholder="Academic Name"
                                    type="text" value="{{$data->academic_name }}"  required/>
                                @if($errors->has('academic_name'))
                                <div class="invalid-feedback">{{ $errors->first('academic_name') }}</div>
                                @enderror
                            </div>
