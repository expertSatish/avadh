                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-4 form-group">
                                ...
                                <img src="{{asset($data->banner)}}" style="width:300px" >
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                <input class="form-control" name="title" placeholder="Banner Title" value="{{$data->title}}" type="text" />
                                @if($errors->has('title'))
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                <input class="form-control" name="content" placeholder="Content" value="{{$data->content}}" type="text" />
