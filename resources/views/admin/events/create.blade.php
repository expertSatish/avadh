    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class=" container card-fixed-align">
            ...
            <div class="card card-custom">
                <!--begin::Form-->
                <form action="{{route('manage-event.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                <input class="form-control" name="event_name" type="text" placeholder="name..." required />
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 form-group">
                                <textarea class="ckeditor form-control " name="description" type="text" placeholder="Description"></textarea>
                            </div>
                        </div>
