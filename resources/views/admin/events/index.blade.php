                    ...
                    <table class="table table-bordered ">
                        <thead>
                            ...
                            <tr>
                                ...
                                <td><a href="{{route('manage-event.edit', $data->id)}}" class="text text-primary mr-2" title="" data-toggle="tooltip" data-placement="top" data-original-title="Edit">
                                        <en class="la la-edit icon-lg"></en>
                                    </a>
                                    <a href="{{route('manage-event.destroy', $data->id)}}" class="text text-danger mr-2" title="" data-toggle="tooltip" data-placement="top" data-original-title="delete">
