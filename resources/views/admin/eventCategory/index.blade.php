        ...
        <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                ...
                <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">
                    event Category  List</h5>
                <div class="subheader-separator subheader-separator-ver mt-2 mb-2 mr-4 bg-gray-200"></div>
                <a href="{{route('event-category.create')}}" class="btn btn-light-warning font-weight-bolder btn-sm">
                    Add New
                </a>
                <!--end::Page Title-->
    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class=" container card-fixed-align">
            ...
            <div class="card card-custom">
                ...
                <div class="card-body">
                    <!--begin: Datatable-->
                    <table class="table table-bordered eventCategoy-dataTable">
                        <thead>
                            <tr>
                                <td>Title</td>
