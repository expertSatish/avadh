                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-4 form-group">
                                <label>Title</label>
                                <input class="form-control" name="title" placeholder="Name" type="text" required/>
                                @if($errors->has('name'))
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                <input class="form-control" name="thumbnail_img" type="file" required/>
                              
                            </div>
                            <div class="col-md-4 form-group">
                                <label>Short Description: </label>
                                <textarea class="form-control" rows="3" cols="120" name="short_desc" placeholder="Short Description..."></textarea>
                            </div>  
                        </div>
