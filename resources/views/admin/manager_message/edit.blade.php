    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class=" container card-fixed-align">
            ...
            <div class="card card-custom">
                <!--begin::Form-->
                <form action="{{route('manager-message.update',$data->id)}}" method="post"
                        ...
                        <div class="row">
                            <div class="col-md-4 form-group">
                                ...
                                <input class="form-control" name="name"
                                    value="@if(old('name')){{ old('name') }}@elseif($data){{$data->name}}@endif"
                                    type="text" />
                                @if($errors->has('name'))
                            ...
                            <div class="col-md-4 form-group">
                                <label>Image </label>
                                <input class="form-control" name="manager_image" type="file" />
                                @if($errors->has('manager_image'))
                                <div class="invalid-feedback">{{ $errors->first('manager_image') }}</div>
                                @enderror
                            </div>
                        </div>
                        <div class="row">
