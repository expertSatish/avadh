                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                <select name="department_name" class="form-control" value="{{$data->department_name}}">
                                    <option value="">Select section</option>
                                    @foreach($department as $res)
                                        <option value="{{$res->name}}" @if(old('name') == $res->name) selected @elseif($data->department_name == $res->name) selected @endif>{{$res->name}}</option>
                                    @endforeach
                                </select>                                
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                <input class="form-control" name="faculty_name" value="@if(old('faculty_name')){{ old('faculty_name') }}@elseif($data){{$data->faculty_name}}@endif" placeholder="Faculty Name"
                                    type="text" />
                            ...
                            <div  class="col-md-4 form-group">
                                ...
                                <input class="form-control" name="faculty_image"  placeholder="Faculty Image"
                                    type="file" />
                                    <img src="{{asset($data->faculty_image)}}" width="20%">
                            </div>
