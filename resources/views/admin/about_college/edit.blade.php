    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class=" container card-fixed-align">
            ...
            <div class="card card-custom">
                <!--begin::Form-->
                <form action="{{route('college.update',$data->id)}}" method="post" enctype="multipart/form-data">
                    @method('PATCH')
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-4 form-group">
                                ...
                                <div class="invalid-feedback">{{ $errors->first('about_image') }}</div>
                                @enderror
                            </div>
                        </div>
                        <div class="row">
