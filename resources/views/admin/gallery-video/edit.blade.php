    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class=" container card-fixed-align">
            ...
            <div class="card card-custom">
                <!--begin::Form-->
                <form action="{{route('videoData.update',$data->id)}}" method="post" enctype="multipart/form-data">
                    @method('PATCH')
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                ...
                                <input class="form-control" name="video_link" type="text" value="{{$data->video_link}}" required placeholder="Video Link..." />
                            </div>
                        </div>
