    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class=" container card-fixed-align">
            ...
            <div class="card card-custom">
                <!--begin::Form-->
                <form action="{{route('awards.update',$data->id)}}" method="post" enctype="multipart/form-data">
                    @method('PATCH')
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                <input class="form-control" name="title" placeholder="Image Title" value="{{$data->title}}" type="text" />
                                @if($errors->has('title'))
