        ...
        <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                ...
                Gallery List</h5>
                    ...
                    <a href="{{route('gallery.create')}}" class="btn btn-light-warning font-weight-bolder btn-sm">
                        Add New
                    </a>
                <!--end::Page Title-->
    ...
    <table class="table table-bordered ">
        <thead>
            ...
            <tr>
                ...
                <td><a href="{{route('gallery.edit', $data->id)}}" class="text text-primary mr-2" title="" data-toggle="tooltip" data-placement="top" data-original-title="Edit">
                        <en class="la la-edit icon-lg"></en>
                    </a>
                    <a href="{{route('gallery.destroy', $data->id)}}" class="text text-danger mr-2" title="" data-toggle="tooltip" data-placement="top" data-original-title="delete">
                        <en class="la la-trash icon-lg"></en>
                    </a>
                </td>
            </tr>
            @endforeach
